document.addEventListener('DOMContentLoaded', function() {
	...
	let carouselInit = document.getElementById("carousel-init"),
		...
		carouselInit.addEventListener("click", ()=>initCarousel(visibleItems.value));
});

function initCarousel(visibleItems) {
	'use strict';
	let carousel = {
		carouselBlock: document.getElementById("carousel"),
		wrapper: document.getElementById("carousel-wrapper"),
		visibleItems, // slides amount
	...
	carousel.makeStep(); // for relaunch with different params
